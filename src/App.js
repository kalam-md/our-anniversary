...
const HeroSection = () => {
  ...
  const originalPhotos = [
    ...
    { id: 5, src: '/img/sample5.jpeg', alt: 'Couple photo 5' },
    { id: 6, src: '/img/sample6.jpeg', alt: 'Couple photo 6' },
    { id: 7, src: '/img/sample7.jpeg', alt: 'Couple photo 7' },
    { id: 8, src: '/img/sample8.jpeg', alt: 'Couple photo 8' },
    { id: 9, src: '/img/sample9.jpeg', alt: 'Couple photo 9' },
    { id: 13, src: '/img/sample13.jpeg', alt: 'Couple photo 13' },
    { id: 14, src: '/img/sample14.jpeg', alt: 'Couple photo 14' },
    { id: 16, src: '/img/sample16.jpeg', alt: 'Couple photo 16' },
    { id: 17, src: '/img/sample17.jpeg', alt: 'Couple photo 17' },
    { id: 19, src: '/img/sample19.jpeg', alt: 'Couple photo 19' },
    { id: 20, src: '/img/sample20.jpeg', alt: 'Couple photo 20' },
  ];
